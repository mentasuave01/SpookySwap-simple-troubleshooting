...
// data
const yesb = () => {
  document.getElementById("first").innerHTML = '      Check token list <a class="text-blue-400" target="_blank" rel="noreferrer"   href="https://ftmscan.com/"> here</a><br/>  Token format is anyTOKEN<div class="flex">1.Ask for fees 	&nbsp; <a class="text-blue-400" target="_blank" rel="noreferrer" href="https://www.mentasuave01-tools.com/"> here	&nbsp;</a></div><div class="flex">2. Go to 	&nbsp;<a target="_blank" rel="noreferrer"   class="text-blue-400" href="https://anyswap.exchange/#/pool">this	&nbsp;</a> website and follow 	&nbsp;<a class="text-blue-400" target="_blank" rel="noreferrer" href="https://imgur.com/a/Mte0D5h"> this	&nbsp;</a> instructions</div>   </br> If token is there but not showing on metamask go<br/><a target="_blank" rel="noreferrer"   class="text-blue-400" href="https://docs.spookyswap.finance/products/bridge#5.-view-your-bridged-token"> here</a><br/>  '
